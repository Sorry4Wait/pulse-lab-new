...
import MyHomeIcon from './custom_icons/MyHomeIcon.vue'
import MyUserIcon from './custom_icons/MyUserIcon.vue';
import MyLabIcon from './custom_icons/MyLabIcon.vue';
import MyFolderIcon from './custom_icons/MyFolderIcon.vue';
...
export default (app) => {
  ...
  app.component("MyHomeIcon", MyHomeIcon);
  app.component("MyUserIcon", MyUserIcon);
  app.component("MyLabIcon", MyLabIcon);
  app.component("MyFolderIcon", MyFolderIcon);
