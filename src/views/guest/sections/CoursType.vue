<template>
  ...
  <div class="types">
    <swiper :slidesPerView="4.5" :spaceBetween="20" class="swiper-wrapper">
      <swiper-slide class="swiper-slide" v-for="(type, index) in cTypes" :key="index">
        <a
          href="#"
          @click.prevent="myFunction(index,type.title)"
...
<script setup>
  ...
  const changeColor = () => {
    let color = cTypes.value[isActive.value].color;
    emit('colorChange',color);
  };
  const myFunction = (index, name) => {
