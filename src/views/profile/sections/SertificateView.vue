<template>
  <div class="my__container">
    <div
      class="main"
      :class="{
        seismic: currentCourse == 'seismic',
        electrical: currentCourse == 'electrical',
        magnetic: currentCourse == 'magnetic',
        gravity: currentCourse == 'gravity',
        seismologic: currentCourse == 'seismologic',
      }"
    >
      <div>
        <div class="pb-11">
