<template>
  <div class="otch_card" :style="{ 'border-left-color': color }">
    <div class="bg__mask" :style="{ background: color }"></div>
    <div class="body">
      <strong>{{ course }}</strong>
      <p class="name">{{$t("labWork")}} {{ name }}</p>
      <div class="files">
        <a href="#!">
          <svg
            width="40"
