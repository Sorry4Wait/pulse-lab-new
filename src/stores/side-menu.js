...
export const useSideMenuStore = defineStore("sideMenu", {
  state: () => ({
    ...
    menu: [
      ...
      //     {
      //       icon: "",
      //       pageName: "side-menu-notifications",
      //       title: "Уведомления",
      //     },
      //   ]
      // },
      {
        ...
        subMenu: [
          {
            icon: "my-folder-icon",
            pageName: "side-menu-seismic",
            title: "Seismic",
          },
          // {
          //   icon: "my-folder-icon",
          //   pageName: "vertical-electrical-sounding",
          //   title: "ElectricalProspecting",
          //
          // },
          {
            icon: "my-folder-icon",
            ...
            subMenu: [
              {
                icon: "",
                pageName: "vertical-electrical-sounding-lab1",
                title: "Lab1",
              },
              {
                icon: "",
                pageName: "vertical-electrical-sounding-lab2",
                title: "Lab2",
              },
            ]
          },
